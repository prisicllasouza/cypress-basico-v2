...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('campo de telefone continua vazio quando preenchido por valor não numérico', function () {
        cy.get('#phone')
            .type('!@¨%$$$%')
            .should('have.value', '')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
        ...
        cy.get('#lastName')
            ...
            .should('have.value', '')
        cy.get('#email')
            .type('p.souza7@gmail.com')
            .should('have.value', 'p.souza7@gmail.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('1234567890')
    ...
    it('exibe e esconde as mensagens de sucesso e erro usando o .invoke', () => {
      ...
      it('preenche a area de texto usando o comando invoke', () => {
        ...
        it.only('exibe o gato escondido usando o .invoke', () => {
            cy.get('#cat')
              .invoke('show')
              .should('be.visible')
            cy.get('#title')
